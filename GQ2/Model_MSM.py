...
def function1(u, v, denum1, denum2, prob1, prob2, rho):
    ...
    result = gaussian_copula.bivariate_gaussian_copula_pdf(F1, F2, np.array([rho]))
...
if __name__ == "__main__":
    ...
    """
    VaR = VaR_gaussian_copula(y_sp500, pmatsp500, sigmasp500/100, m0sp500, y_nasdaq, pmatnasdaq, sigmanasdaq/100, m0nasdaq, k_compos, optimal_rho)
